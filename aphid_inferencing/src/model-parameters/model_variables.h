...
const char* ei_classifier_inferencing_categories[] = { "aphid" };

ei_dsp_named_axis_t ei_dsp_config_7_named_axes[] = {
    { .name = "Image", .axis = 0 }
};
size_t ei_dsp_config_7_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_7_axes[] = { 0 };
const uint32_t ei_dsp_config_7_axes_size = 1;
ei_dsp_config_image_t ei_dsp_config_7 = {
    7, // uint32_t blockId
    1, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_7_named_axes, // named axes
    ei_dsp_config_7_named_axes_size, // size of the named axes array
    "RGB" // select channels
};
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_8 = {
    .implementation_version = 1,
...
const uint32_t ei_learning_block_8_inputs[1] = { 7 };
...
const ei_impulse_t impulse_659837_0 = {
    .project_id = 659837,
    .project_owner = "Agustin Alejandro Mota Hinojosa",
    .project_name = "aphid",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_659837_0 = ei_impulse_handle_t( &impulse_659837_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_659837_0;
